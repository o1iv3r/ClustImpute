...
library(ClustImpute)
required_packages <- Hmisc::Cs(psych,ggplot2,tidyr,Hmisc,tictoc,ClusterR,copula,dplyr)
...
We create a few missings using a custom function


```{r}
dat_with_miss <- miss_sim(dat,p=.1,seed_nr=123)
...
length(idx) # number
external_validation(true_clust[idx], res$clusters[idx])
```
